...
GitHub 의 `schedule` cron 은 무료 플랜 private 저장소에서 우선순위가 가장 낮다. 이 저장소에서
실측한 결과 예정 `11:37Z` 슬롯이 **`15:16Z` 에 발화했다 — 3시간 39분 지연.** 그 앞 슬롯은 아예
건너뛰었다 (설정·권한·잔여 분은 모두 정상이었다). "하루 2회 정시 보고" 로는 쓸 수 없어 정기
